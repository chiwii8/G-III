...
public class VistaMonitor extends javax.swing.JPanel {
     ...
     * @param d
     */
    public VistaMonitor(Dimension d) {
        this.setSize(d);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableMonitores.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(jTableMonitores);

        jLabel9.setText("Gestión de Monitores");

        jButtonNuevoMonitor.setText("Nuevo Monitor");
        jButtonNuevoMonitor.setActionCommand("NuevoMonitor");
        jButtonNuevoMonitor.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButtonNuevoMonitorMouseClicked(evt);
            }
        });
        ...
        jButtonActualizarMonitor.setText("Actualizar Monitor");
    ...
    private void jButtonNuevoMonitorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonNuevoMonitorMouseClicked
      /*VistaDialogos v = new VistaDialogos(0).NuevoMonitor();
      v.setModalityType(Dialog.ModalityType.APPLICATION_MODAL);
      v.setVisible(true);*/
    }//GEN-LAST:event_jButtonNuevoMonitorMouseClicked
